...
def train_gnn_classifier(model, train_dataset, val_dataset, device, epochs=300, lr=0.01):
...
def main():
    ...
    train_dataset = Mutagenicity('train')
    valid_dataset = Mutagenicity('valid')
    test_dataset = Mutagenicity('test')
